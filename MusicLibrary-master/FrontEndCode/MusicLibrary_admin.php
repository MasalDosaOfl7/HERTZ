...
<?php
    ...
    function table_songs($result){
        ...
        while ($row=mysqli_fetch_array($result)) {
            ...
            echo "<td><table><tr><td><button type='button' title='Edit Song' onclick='UpdateRecord(".$row['SongID'] . "," . $row_count ." )' style='background-color:transparent; border-color:transparent;'><img src ='https://cdn0.iconfinder.com/data/icons/glyphpack/45/edit-alt-512.png' height=25px width=25px></button></td>";
