...
<html lang="en">
    ...
    <div id="login_container">
        ...
        <input type="password" id="Uname" name="password2" placeholder="Re-enter password" class="table"/> <br><br>  
        ...
        <br/><br/>
        <input type="submit" value="REGISTER" name="register" id = "submit1" class="table"> <br><br>
        <label>Already have an account? &nbsp;&nbsp;<button type="button" id="submit2" onclick ="javasript:LoginPage()">LOG IN</button></label>
        </div>
     </form>
     </body>
</html>
...
<?php
    ...
    { 
        ...
        if (empty($_POST['user_name']) || empty($_POST['password']) || empty($_POST['first_name']) || empty($_POST['last_name'])){
            echo "<font color='red'><h3 style = 'text-align:center;margin-top:8px'>* Please enter all details to register!</h3></font>";
        ...
        //if not extract all info submitted and store in variables.
            ...
            if(mysqli_num_rows($result) > 0 ){
                ...
                echo "<font color='red'><h3 style = 'text-align:center;margin-top:8px'>* User name already used! Please try another username.</h3></font>";
            }
